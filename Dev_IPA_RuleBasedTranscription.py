...
####################################################
	...
	while vowelA != None and vowelB != None :
		...
		for charIndex in range(len(cluster)) :
			if not cluster[charIndex] in "'͡ʃʰʱː̪ʒ" :
...
sonority = {
	'k' : 1, 't͡ʃ' : 1, 'ʈ' : 1, 't̪' : 1, 'p' : 1,
	'kʰ' : 2, 't͡ʃʰ' : 2, 'ʈʰ' : 2, 't̪ʰ' : 2, 'pʰ' : 2,
	'g' : 3, 'd͡ʒ' : 3, 'ɖ' : 3, 'd̪' : 3, 'b' : 3,
	'gʰ' : 4, 'd͡ʒʱ' : 4, 'ɖʰ' : 4, 'd̪ʰ' : 4, 'bʱ' : 4,
	'ŋ' : 5, 'ɲ' : 5, 'ɳ' : 5, 'n' : 5, 'm' : 5,
	'श' : 6, 'ष' : 6, 'स' : 6, 'ह' : 6, 'ळ' : 6,
	'य' : 7, 'र' : 7, 'ल' : 7, 'व' : 7,
	# vowels : 8,
